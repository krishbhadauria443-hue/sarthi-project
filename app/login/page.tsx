    ...
    <div className="antialiased text-[#d8e3fb] flex items-center justify-center min-h-screen overflow-hidden bg-[#081425] relative">
      ...
      <main className="relative z-10 w-full max-w-md px-6 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-sm font-medium tracking-wide text-[#908fa0] uppercase">Development Environment</p>
        </div>
        ...
        <div className="bg-[#2a3548]/40 backdrop-blur-3xl rounded-xl p-8 shadow-[0_20px_40px_rgba(8,20,37,0.6)] border-t border-white/10">
          <div className="mb-8">
            ...
            <p className="text-[#c7c4d7] text-sm mt-1">Please enter your details to continue.</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <button 
              disabled={loading}
              className="w-full bg-gradient-to-br from-[#c0c1ff] to-[#8083ff] text-[#0d0096] font-bold py-4 rounded-full disabled:opacity-50"
            >
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-[0.6875rem] uppercase tracking-widest">
              <span className="bg-[#111c2d] px-3 text-[#908fa0]">Or continue with</span>
            </div>
          </div>
        ...
        <div className="text-center mt-8">
          <p className="text-sm text-[#c7c4d7]">
            ...
            <Link className="text-[#c0c1ff] font-bold ml-1" href="/signup">Sign up</Link>
          </p>
        </div>
      </main>
    </div>
